...
module.exports = function(element) {
  ...
  switch (element[0].name) {
    ...
    case this.components.marketo:
      ...
      return format('<table><tbody><tr><td class="%s" %s>%s</td></tr></tbody></table>', classes.join(' '), attrs, inner);
    ...
    case this.components.spacer:
      ...
      if (element.attr('background')) {
        backgroundColor = element.attr('background')
      }
